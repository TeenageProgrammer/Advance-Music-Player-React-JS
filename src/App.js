  ...
  return (
    <>
      <div className="container">
        <audio src='./Assets/songs/Chasing - NEFFEX.mp3' ref={currentAudio} onEnded={handleNextSong} onTimeUpdate={handleAudioUpdate}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos impedit nesciunt, est sed aspernatur dolores hic, sunt voluptatibus fugiat consequuntur perspiciatis ullam perferendis, optio placeat sequi illo delectus consectetur aperiam.</audio>
        ...
        <div className="music-Container">
          ...
          <div className="song__img">
            <img src={currentMusicDetails.songAvatar} className={avatarClass[avatarClassIndex]} onClick={handleAvatar} alt="song Avatar"  />
          </div>
        ...
        <a href="https://github.com/Fisayomiii/Advance-Music-Player-React-JS" title='Give me a Star' className='youtube-Subs'>
          <img src="./Assets/Images/github.png" alt="Youtube Logo" />
          <p>Github</p>
        </a>
      </div>
    </>
